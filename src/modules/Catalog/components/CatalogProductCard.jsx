...
import App from "../Product/components/Rating";

export const CatalogProductCard = ({productCard}) => {

    const {name, images, id, extended_name, micro_description, prices, name_prefix, reviews} = productCard
    ...
    return(
        <div className="catalog_item">
            ...
            <div className="rating"><App reviews={reviews}/></div>
